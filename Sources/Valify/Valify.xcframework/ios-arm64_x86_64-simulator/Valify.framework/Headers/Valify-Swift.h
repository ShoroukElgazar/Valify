...
#ifndef VALIFY_SWIFT_H
#define VALIFY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Valify",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Valify11AppDelegate")
...
SWIFT_CLASS("_TtC6Valify16CameraController")
...
@interface CameraController (SWIFT_EXTENSION(Valify)) <AVCapturePhotoCaptureDelegate>
...
SWIFT_CLASS("_TtC6Valify30CameraNavigationViewController")
@interface CameraNavigationViewController : UINavigationController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6Valify20CameraViewController")
@interface CameraViewController : UIViewController
@property (nonatomic, strong) IBOutlet UIView * _Null_unspecified capturePreviewView;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)onClickMyButtonWithSender:(UIButton * _Nonnull)sender;
- (IBAction)switchCameras:(UIButton * _Nonnull)sender;
- (IBAction)captureImage:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC6Valify26PhotoPreviewViewController")
...
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
- (void)onClickButton1WithSender:(UIButton * _Nonnull)sender;
- (void)onClickButton2WithSender:(UIButton * _Nonnull)sender;
- (IBAction)retakePhoto:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC6Valify13SceneDelegate")
...
SWIFT_CLASS("_TtC6Valify14ViewController")
